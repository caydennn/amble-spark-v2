...
export default async function Page({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="flex flex-col  w-full h-dvh">
      {currentMatch && (
        <div className="flex flex-col h-full bg-red-200 justify-end">
          <div className="absolute top-0 bg-orange-100 w-full flex justify-around min-h-[50px] items-center font-bold">
            <BackToHomeButton />
